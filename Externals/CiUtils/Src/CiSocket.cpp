...
{
	if ( m_pRecvBuffer == NULL || pStr == NULL )
		return -1;
...
//	아래 함수에 버그가 존재, but 아직 사용하는 곳이 없어 우선 주석 처리
//bool CCiSocket::AppendReadBuffer(const char *pStr, int *pnappend)
//{
//	int ntoappend = CiStrLen(pStr);
//
//	if ( m_iRecvEndPtr > m_iRecvStartPtr )
//	{
//		if ( m_iRecvBufferSize - m_iRecvEndPtr >= ntoappend )
//		{
//			char *ptrAppendPos = m_pRecvBuffer + m_iRecvEndPtr;
//
//			memcpy( ptrAppendPos, pStr, ntoappend );
//
//			m_iRecvEndPtr += ntoappend;
//
//			if ( m_iRecvEndPtr == m_iRecvBufferSize )
//				m_iRecvEndPtr = 0;
//
...
//		else
//		{
//			/* fill to buffer's end point */
//			char *ptrAppendPos = m_pRecvBuffer + m_iRecvEndPtr;
//			const char *ptrRemData = pStr;
//
//			memcpy( ptrAppendPos, ptrRemData, m_iRecvBufferSize - m_iRecvEndPtr );
//
//			/* start from buffer's start point */
//			m_iRecvEndPtr = 0;
//			ptrAppendPos = m_pRecvBuffer;
//
//			ptrRemData += m_iRecvBufferSize - m_iRecvEndPtr;
//			ntoappend -= m_iRecvBufferSize - m_iRecvEndPtr;
//			*pnappend = m_iRecvBufferSize - m_iRecvEndPtr;
//
//			if ( m_iRecvStartPtr > ntoappend )
//			{
//				memcpy( ptrAppendPos, ptrRemData, ntoappend );
//				m_iRecvEndPtr += ntoappend;
//
//				*pnappend += ntoappend;
//
...
//			else
//			{
//				memcpy( ptrAppendPos, ptrRemData, m_iRecvStartPtr - 1 );
//				m_iRecvEndPtr += m_iRecvStartPtr - 1;
//
//				*pnappend += m_iRecvStartPtr - 1;
//
//				return false;
//			}
//		}
...
//	else if ( m_iRecvEndPtr < m_iRecvStartPtr )
//	{
//		if ( m_iRecvStartPtr - m_iRecvEndPtr > ntoappend )
//		{
//			char *ptrAppendPos = m_pRecvBuffer + m_iRecvEndPtr;
//
//			memcpy( ptrAppendPos, pStr, ntoappend );
...
//			char *ptrAppendPos = m_pRecvBuffer + m_iRecvEndPtr;
//
//			memcpy( ptrAppendPos, pStr, m_iRecvStartPtr - m_iRecvEndPtr - 1 );
//
//			m_iRecvEndPtr += m_iRecvStartPtr - m_iRecvEndPtr - 1;
//
//			*pnappend = m_iRecvStartPtr - m_iRecvEndPtr - 1;
//
//			return false;
//		}
//	}
